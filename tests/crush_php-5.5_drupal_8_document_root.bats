...
DOCKER_COMPOSE_FILE="${BATS_TEST_DIRNAME}/crush_php-5.5_drupal_8_document_root.yml"
...
setup_drupal() {
  docker exec "$(container)" /bin/su - container -lc "wget https://ftp.drupal.org/files/projects/drupal-8.0.2.tar.gz -O /tmp/drupal-8.0.2.tar.gz"
...
@test "crush: php-5.5: drupal 8: document root" {
