...
DOCKER_COMPOSE_FILE="${BATS_TEST_DIRNAME}/crush_php-5.3_drupal_6_document_root.yml"
...
setup_drupal() {
  ...
  docker exec "$(container)" /bin/su - container -lc "rsync -avz /tmp/drupal-6.37/ /var/www"
...
@test "crush: php-5.3: drupal 6: document root" {
